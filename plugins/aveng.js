...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'aveng ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/logoaveng?apikey=Upe1Fp1lDAtX0ioPYLEPsSoX51i&text1=SPlRlT SER&text2=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
