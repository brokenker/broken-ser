...
if (conf.LANG == 'EN') vtalk_dsc = 'Starts to SPlRlT SER voice chat.', reply_eva = '*Reply to Any Voice Message!*'
...
var succ_off = ''
if (conf.LANG == 'TR') {
    fulleva_dsc = 'Tam fonksiyonel SPlRlT SER özelliklerini aktif eder. Hesabınızı bir chatbota dönüştürün!'
    already_on = 'SPlRlT SER yapay zekası halihazırda tüm fonksiyonları etkin.'
    already_off = 'SPlRlT SER yapay zekası halihazırda yarı fonksiyonel çalışıyor.'
    succ_on = 'SPlRlT SER, Tam Fonksiyonel Olarak Açıldı! Lütfen Biraz Bekleyin! ✅'
    succ_off = 'SPlRlT SER, Yarı Fonksiyonel Olarak Ayarlandı! Lütfen Biraz Bekleyin! ☑️'
}
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Activates full functional SPlRlT SER features. Turn your account into a ai chatbot!'
    already_on = 'SPlRlT SER artificial intelligence is already fully functional.'
    already_off = 'SPlRlT SER artificial intelligence is currently running semi-functional.'
    succ_on = 'SPlRlT SER Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'SPlRlT SER Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'ML') {
